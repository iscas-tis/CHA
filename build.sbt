...
val defaultVersions = Map(
  "firrtl" -> "edu.berkeley.cs" %% "firrtl" % "1.5.0-RC1",
  "treadle" -> "edu.berkeley.cs" %% "treadle" % "1.5.0-RC1",
  "chiseltest" -> "edu.berkeley.cs" %% "chiseltest" % "0.5.0-RC1",
)
...
lazy val chiseltestRef = ProjectRef(workspaceDirectory / "chisel-testers2", "chisel-testers2")
...
lazy val chisel = (project in file(".")).
  ...
  settings(
    ...
    libraryDependencies += defaultVersions("chiseltest"),
